<x-layout>
    ...
    <main class="px-8 py-4 h-[88vh] flex items-center justify-center">
        <img src="{{ $olimpiade->thumbnail ? '/image/background/dashboard.png' : '/storage/' . $olimpiade->image }}"
            alt="dashboard image" class="opacity-50 object-cover w-full h-full rounded-md blur-sm">
