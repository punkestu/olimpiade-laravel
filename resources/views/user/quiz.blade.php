            ...
            <ul class="font-normal text-gray-700 dark:text-gray-400 flex flex-col gap-2">
                <li class="flex items-center gap-2">
                    ...
                    <label for="answer1" id="answer1-content"
                        class="p-1 rounded-md border-2 peer-checked/answer:border-blue-400 [&_#sym]:bg-gray-300 peer-checked/answer:[&_#sym]:bg-blue-400 peer-checked/answer:[&_#sym]:text-white flex items-center gap-2 w-full [&_li]:gap-1 [&_ol]:list-decimal [&_ol]:ms-4  [&_table]:border [&_td]:border [&_th]:border [&_td]:p-1 [&_th]:p-1 [&_td]:max-w-[40%] [&_th]:max-w-[40%] [&_th]:bg-gray-300 [&_td]:text-wrap [&_th]:text-wrap  ">
                        <span id="sym"
