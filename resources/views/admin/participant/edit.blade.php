<x-layout>
    ...
    <main class="p-4 sm:ml-64">
        ...
        <div class="mt-4 bg-white dark:bg-gray-800 shadow overflow-hidden sm:rounded-lg">
            ...
            <form action="{{ route('participant.update-password', $participant) }}" method="POST">
                @csrf
                <div class="border-t border-gray-200 dark:border-gray-700">
                    <dl>
                        ...
                        <div class="bg-gray-50 dark:bg-gray-700 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                            ...
                            <dd class="mt-1 text-sm text-gray-900 sm:col-span-2">{{ $participant->olimpiade->name }}
                            </dd>
                        </div>
                        <div class="bg-white dark:bg-gray-800 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6 items-center">
